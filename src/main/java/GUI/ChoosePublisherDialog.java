 ...
 * @author User
 */
public class ChoosePublisherDialog extends javax.swing.JDialog {
    private BookBUS bookBUS;
    private PublisherDTO pub;
    private Runnable onDisposeCallback;
    /**
     * Creates new form ChoosePulisherDialog
     */
    public ChoosePublisherDialog(java.awt.Frame parent, boolean modal, PublisherDTO pub, Runnable onDisposeCallback) {
        super(parent, modal);
        initComponents();
    ...
    public void setUpTable() throws SQLException{
        ...
        Vector<PublisherDTO> arr = bookBUS.getAllPublisher();
        for(int i=0;i<arr.size();i++){
            PublisherDTO au = arr.get(i);
    ...
    private void initComponents() {
        ...
        addSupplierButton.setText("Chọn nhà xuất bản");
        ...
        jLabel9.setText("DANH SÁCH NHÀ XUẤT BẢN");
    ...
    private void addSupplierButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addSupplierButtonActionPerformed
        ...
        int row = bookNameTable.getSelectedRow();
            if (row >= 0) {
                pub.setId(Integer.parseInt(bookNameTable.getValueAt(row, 0).toString()));
                pub.setName(bookNameTable.getValueAt(row, 1).toString());
                dispose();
            }else{
    ...
    private void myButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_myButton1ActionPerformed
        try {
            // TODO add your handling code here:
            JOptionPane.showMessageDialog(null, bookBUS.AddPublisher(new PublisherDTO(supplierNameTextField.getText().trim())));
            setUpTable();
...
//            java.util.logging.Logger.getLogger(ChoosePublisherDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                ChoosePublisherDialog dialog = new ChoosePublisherDialog(new javax.swing.JFrame(), true);

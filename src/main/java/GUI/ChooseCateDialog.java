 ...
 * @author User
 */
public class ChooseCateDialog extends javax.swing.JDialog {
    private BookBUS bookBUS;
    private CategoryDTO cate;
    private Runnable onDisposeCallback;
    /**
     * Creates new form ChooseCateDialog
     */
    public ChooseCateDialog(java.awt.Frame parent, boolean modal, CategoryDTO cate, Runnable onDisposeCallback) {
        super(parent, modal);
        initComponents();
    ...
    public void setUpTable() throws SQLException{
        ...
        Vector<CategoryDTO> arr = bookBUS.getAllCategory();
        for(int i=0;i<arr.size();i++){
            CategoryDTO au = arr.get(i);
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Thêm thể loại mới");
        ...
        addSupplierButton.setText("Chọn thể loại");
        ...
        jLabel9.setText("DANH SÁCH THỂ LOẠI");
    ...
    private void addSupplierButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addSupplierButtonActionPerformed
        ...
        int row = bookNameTable.getSelectedRow();
            if (row >= 0) {
                cate.setId(Integer.parseInt(bookNameTable.getValueAt(row, 0).toString()));
                cate.setName(bookNameTable.getValueAt(row, 1).toString());
                dispose();
            }else{
    ...
    private void myButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_myButton1ActionPerformed
        ...
        try {
            // TODO add your handling code here:
            JOptionPane.showMessageDialog(null, bookBUS.AddCategory(new CategoryDTO(supplierNameTextField.getText().trim())));
            setUpTable();
...
//            java.util.logging.Logger.getLogger(ChooseCateDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                ChooseCateDialog dialog = new ChooseCateDialog(new javax.swing.JFrame(), true);

...
public class AddCateDialog extends javax.swing.JDialog {
     ...
     */
    public AddCateDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        cateNameTextField = new MyDesign.MyTextField_Basic();
        ...
        cateNameTextField.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(229, 229, 229)));

        addCateButton.setBackground(new java.awt.Color(22, 113, 221));
        addCateButton.setForeground(new java.awt.Color(255, 255, 255));
        addCateButton.setText("Thêm thể loại");
        addCateButton.setBorderColor(new java.awt.Color(22, 113, 221));
        addCateButton.setColor(new java.awt.Color(22, 113, 221));
        addCateButton.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelBorder_Basic1Layout.createSequentialGroup()
                ...
                .addGroup(panelBorder_Basic1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(panelBorder_Basic1Layout.createSequentialGroup()
                        ...
                        .addComponent(cateNameTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 194, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(addCateButton, javax.swing.GroupLayout.PREFERRED_SIZE, 290, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(44, 44, 44))
        );
        panelBorder_Basic1Layout.setVerticalGroup(
            ...
            .addGroup(panelBorder_Basic1Layout.createSequentialGroup()
                ...
                .addGroup(panelBorder_Basic1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel8)
                    .addComponent(cateNameTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addComponent(addCateButton, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddCateDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddCateDialog dialog = new AddCateDialog(new javax.swing.JFrame(), true);
    ...
    private MyDesign.MyTextField_Basic cateNameTextField;

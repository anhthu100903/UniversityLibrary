 ...
 * @author User
 */
public class ChooseSupplierDialog extends javax.swing.JDialog {
    private BookBUS bookBUS;
    private SupplierDTO sup;
    private Runnable onDisposeCallback;
    /**
     * Creates new form ChooseSupplierDialog
     */
    public ChooseSupplierDialog(java.awt.Frame parent, boolean modal, SupplierDTO sup, Runnable onDisposeCallback) {
        super(parent, modal);
        initComponents();
    ...
    public void setUpTable() throws SQLException{
        ...
        Vector<SupplierDTO> arr = bookBUS.getAllSupplier();
        for(int i=0;i<arr.size();i++){
            SupplierDTO au = arr.get(i);
            Object row[] = {au.getId(),au.getName(),au.getAddress(),au.getTel()};
    ...
    private void initComponents() {
        ...
        supplierAddressTextField = new MyDesign.MyTextField_Basic();
        jLabel11 = new javax.swing.JLabel();
        supplierTelTextField = new MyDesign.MyTextField_Basic();
        ...
        addSupplierButton.setText("Chọn nhà cung cấp");
        ...
        supplierAddressTextField.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(229, 229, 229)));

        jLabel11.setFont(new java.awt.Font("SansSerif", 1, 16)); // NOI18N
        jLabel11.setText("Số điện thoại");

        supplierTelTextField.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(229, 229, 229)));
            ...
            .addGroup(panelBorder_Basic1Layout.createSequentialGroup()
                ...
                .addGroup(panelBorder_Basic1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(panelBorder_Basic1Layout.createSequentialGroup()
                        ...
                        .addGroup(panelBorder_Basic1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(panelBorder_Basic1Layout.createSequentialGroup()
                                .addComponent(supplierTelTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 194, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(29, 29, 29)
                                .addComponent(myButton1, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(supplierAddressTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 430, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(panelBorder_Basic1Layout.createSequentialGroup()
                ...
                .addGroup(panelBorder_Basic1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelBorder_Basic1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(supplierTelTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void addSupplierButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addSupplierButtonActionPerformed
        ...
        int row = bookNameTable.getSelectedRow();
            if (row >= 0) {
                sup.setId(Integer.parseInt(bookNameTable.getValueAt(row, 0).toString()));
                sup.setName(bookNameTable.getValueAt(row, 1).toString());
                dispose();
            }else{
    ...
    private void myButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_myButton1ActionPerformed
        ...
        try {
            // TODO add your handling code here:
            JOptionPane.showMessageDialog(null, bookBUS.AddSupplier(new SupplierDTO(supplierNameTextField.getText().trim(), supplierAddressTextField.getText().trim(), supplierTelTextField.getText().trim())));
            setUpTable();
...
//            java.util.logging.Logger.getLogger(ChooseSupplierDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                ChooseSupplierDialog dialog = new ChooseSupplierDialog(new javax.swing.JFrame(), true);
...
//    }
    ...
    private MyDesign.MyTextField_Basic supplierAddressTextField;
    private MyDesign.MyTextField_Basic supplierNameTextField;
    private MyDesign.MyTextField_Basic supplierTelTextField;

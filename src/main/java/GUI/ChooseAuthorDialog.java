 ...
 * @author User
 */
public class ChooseAuthorDialog extends javax.swing.JDialog {
    private BookBUS bookBUS;
    private AuthorDTO au;
    private Runnable onDisposeCallback;
    /**
     * Creates new form ChooseAuthorDialog
     */
    public ChooseAuthorDialog(java.awt.Frame parent, boolean modal, AuthorDTO au, Runnable onDisposeCallback) {
        super(parent, modal);
        initComponents();
    ...
    public void setUpTable() throws SQLException{
        ...
        Vector<AuthorDTO> arr = bookBUS.getAllAuthor();
        for(int i=0;i<arr.size();i++){
            AuthorDTO au = arr.get(i);
            String dob = "";
            if (au.getYear() != 0){
                dob = String.valueOf(au.getYear());
            }
            Object row[] = {au.getId(),au.getName(),dob};
    ...
    private void initComponents() {
        ...
        supplierNameTextField1 = new MyDesign.MyTextField_Basic();
        jLabel4 = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);

        jLabel8.setFont(new java.awt.Font("SansSerif", 1, 16)); // NOI18N
        jLabel8.setText("Tên tác giả mới");
        ...
        addSupplierButton.setText("Chọn tác giả");
        ...
        jLabel9.setText("DANH SÁCH TÁC GIẢ");
        ...
        supplierNameTextField1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(229, 229, 229)));
                    ...
                    .addGroup(panelBorder_Basic1Layout.createSequentialGroup()
                        .addGroup(panelBorder_Basic1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(panelBorder_Basic1Layout.createSequentialGroup()
                                ...
                                .addGap(100, 100, 100)
                                .addComponent(supplierNameTextField1, javax.swing.GroupLayout.PREFERRED_SIZE, 194, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void addSupplierButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addSupplierButtonActionPerformed
        ...
        int row = bookNameTable.getSelectedRow();
            if (row >= 0) {
                au.setId(Integer.parseInt(bookNameTable.getValueAt(row, 0).toString()));
                au.setName(bookNameTable.getValueAt(row, 1).toString());
                dispose();
            }else{
    ...
    private void myButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_myButton1ActionPerformed
        // TODO add your handling code here:
        String year = supplierNameTextField1.getText().trim();
        if (year.equals("")){
            year = "0";
        }
        try {
            JOptionPane.showMessageDialog(null, bookBUS.addAuthor(new AuthorDTO(supplierNameTextField.getText().trim(), Integer.parseInt(year))));
            setUpTable();
...
//            java.util.logging.Logger.getLogger(ChooseAuthorDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                ChooseAuthorDialog dialog = new ChooseAuthorDialog(new javax.swing.JFrame(), true);
...
//    }
    ...
    private MyDesign.MyTextField_Basic supplierNameTextField1;
